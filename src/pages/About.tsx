...
export const About = () => {
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-lg text-sm">
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-lg font-semibold text-primary">Choosing a timerange</h2>
        <ul className="flex flex-col gap-2 text-muted-foreground">
          <li>
            <span className="font-medium text-foreground">All series until now</span> —
            summarizes every previous season plus the current season up to your
            episode. Great for "I stopped watching a while ago," but with many
            seasons the LLM is condensing a lot of plot into a short recap, so
            expect broader strokes and fewer details.
          </li>
          <li>
            <span className="font-medium text-foreground">Season until now</span> —
          ...
          <li>
            ...
            uses the single episode's TMDB synopsis directly, no LLM
            involved. Fastest option and the most detail, but limited to that
            one episode.
          </li>
        </ul>
      </section>
      ...
      <section className="flex flex-col gap-2">
        ...
        <ul className="flex flex-col gap-2 text-muted-foreground">
          <li>
            ...
            quality depend on your hardware and the model you've pulled;
            smaller local models may produce rougher summaries than a hosted
            frontier model.
          </li>
          <li>
            ...
            — hosted models, generally faster and higher quality, but require
            an API key and send episode synopses to that provider.
          </li>
        </ul>
      </section>
